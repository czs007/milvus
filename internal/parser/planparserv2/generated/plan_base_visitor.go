...
func (v *BasePlanVisitor) VisitTimestamptzRange(ctx *TimestamptzRangeContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BasePlanVisitor) VisitTimestamptzReverseRange(ctx *TimestamptzReverseRangeContext) interface{} {
	return v.VisitChildren(ctx)
}
