...
type PlanVisitor interface {
	...
	// Visit a parse tree produced by PlanParser#TimestamptzRange.
	VisitTimestamptzRange(ctx *TimestamptzRangeContext) interface{}
	...
	// Visit a parse tree produced by PlanParser#TimestamptzReverseRange.
	VisitTimestamptzReverseRange(ctx *TimestamptzReverseRangeContext) interface{}
