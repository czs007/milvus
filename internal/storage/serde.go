...
var serdeMap = func() map[schemapb.DataType]serdeEntry {
	...
	m[schemapb.DataType_Bool] = serdeEntry{
		...
		deserialize: func(a arrow.Array, i int, _ schemapb.DataType, dim int, shouldCopy bool) (any, error) {
			...
			return nil, merr.WrapErrParameterInvalidMsg("expected *array.Boolean, got %T", a)
		},
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			...
			if builder, ok := b.(*array.BooleanBuilder); ok {
				...
				return merr.WrapErrParameterInvalidMsg("expected bool value, got %T", v)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.BooleanBuilder, got %T", b)
		},
	}
	m[schemapb.DataType_Int8] = serdeEntry{
		...
		deserialize: func(a arrow.Array, i int, _ schemapb.DataType, dim int, shouldCopy bool) (any, error) {
			...
			return nil, merr.WrapErrParameterInvalidMsg("expected *array.Int8, got %T", a)
		},
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			if v == nil {
				b.AppendNull()
			...
			if builder, ok := b.(*array.Int8Builder); ok {
				...
				return merr.WrapErrParameterInvalidMsg("expected int8 value, got %T", v)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.Int8Builder, got %T", b)
		},
	}
	m[schemapb.DataType_Int16] = serdeEntry{
		...
		deserialize: func(a arrow.Array, i int, _ schemapb.DataType, dim int, shouldCopy bool) (any, error) {
			...
			return nil, merr.WrapErrParameterInvalidMsg("expected *array.Int16, got %T", a)
		},
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			if v == nil {
				b.AppendNull()
			...
			if builder, ok := b.(*array.Int16Builder); ok {
				...
				return merr.WrapErrParameterInvalidMsg("expected int16 value, got %T", v)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.Int16Builder, got %T", b)
		},
	}
	m[schemapb.DataType_Int32] = serdeEntry{
		...
		deserialize: func(a arrow.Array, i int, _ schemapb.DataType, dim int, shouldCopy bool) (any, error) {
			...
			return nil, merr.WrapErrParameterInvalidMsg("expected *array.Int32, got %T", a)
		},
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			if v == nil {
				b.AppendNull()
			...
			if builder, ok := b.(*array.Int32Builder); ok {
				...
				return merr.WrapErrParameterInvalidMsg("expected int32 value, got %T", v)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.Int32Builder, got %T", b)
		},
	}
	m[schemapb.DataType_Int64] = serdeEntry{
		...
		deserialize: func(a arrow.Array, i int, _ schemapb.DataType, dim int, shouldCopy bool) (any, error) {
			...
			return nil, merr.WrapErrParameterInvalidMsg("expected *array.Int64, got %T", a)
		},
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			if v == nil {
				b.AppendNull()
			...
			if builder, ok := b.(*array.Int64Builder); ok {
				...
				return merr.WrapErrParameterInvalidMsg("expected int64 value, got %T", v)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.Int64Builder, got %T", b)
		},
	}
	m[schemapb.DataType_Float] = serdeEntry{
		...
		deserialize: func(a arrow.Array, i int, _ schemapb.DataType, dim int, shouldCopy bool) (any, error) {
			...
			return nil, merr.WrapErrParameterInvalidMsg("expected *array.Float32, got %T", a)
		},
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			if v == nil {
				b.AppendNull()
			...
			if builder, ok := b.(*array.Float32Builder); ok {
				...
				return merr.WrapErrParameterInvalidMsg("expected float32 value, got %T", v)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.Float32Builder, got %T", b)
		},
	}
	m[schemapb.DataType_Double] = serdeEntry{
		...
		deserialize: func(a arrow.Array, i int, _ schemapb.DataType, dim int, shouldCopy bool) (any, error) {
			...
			return nil, merr.WrapErrParameterInvalidMsg("expected *array.Float64, got %T", a)
		},
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			if v == nil {
				b.AppendNull()
			...
			if builder, ok := b.(*array.Float64Builder); ok {
				...
				return merr.WrapErrParameterInvalidMsg("expected float64 value, got %T", v)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.Float64Builder, got %T", b)
		},
	}
	...
	stringEntry := serdeEntry{
		...
		deserialize: func(a arrow.Array, i int, _ schemapb.DataType, dim int, shouldCopy bool) (any, error) {
			...
			return nil, merr.WrapErrParameterInvalidMsg("expected *array.String, got %T", a)
		},
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			if v == nil {
				b.AppendNull()
			...
			if builder, ok := b.(*array.StringBuilder); ok {
				...
				return merr.WrapErrParameterInvalidMsg("expected string value, got %T", v)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.StringBuilder, got %T", b)
		},
	}
		...
		deserialize: func(a arrow.Array, i int, _ schemapb.DataType, dim int, shouldCopy bool) (any, error) {
			...
			if arr, ok := a.(*array.Binary); ok && i < arr.Len() {
				...
				if err := proto.Unmarshal(arr.Value(i), v); err == nil {
					...
					return nil, merr.WrapErrServiceInternalErr(err, "failed to unmarshal ScalarField")
				}
			}
			return nil, merr.WrapErrParameterInvalidMsg("expected *array.Binary, got %T", a)
		},
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			if v == nil {
				b.AppendNull()
			...
			if builder, ok := b.(*array.BinaryBuilder); ok {
				if vv, ok := v.(*schemapb.ScalarField); ok {
					if bytes, err := proto.Marshal(vv); err == nil {
						...
						return merr.WrapErrServiceInternalErr(err, "failed to marshal ScalarField")
					}
				}
				return merr.WrapErrParameterInvalidMsg("expected *schemapb.ScalarField value, got %T", v)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.BinaryBuilder, got %T", b)
		},
	}
	_ = eagerArrayEntry
			...
			if builder, ok := b.(*array.BinaryBuilder); ok {
				...
				if vv, ok := v.(*schemapb.VectorField); ok {
					if bytes, err := proto.Marshal(vv); err == nil {
						...
						return merr.WrapErrServiceInternalErr(err, "failed to marshal VectorField")
					}
				}
				return merr.WrapErrParameterInvalidMsg("expected []byte, *schemapb.ScalarField or *schemapb.VectorField value, got %T", v)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.BinaryBuilder, got %T", b)
		},
	}
	...
	m[schemapb.DataType_ArrayOfVector] = serdeEntry{
		...
		serialize: func(b array.Builder, v any, elementType schemapb.DataType) error {
			...
			if !ok {
				return merr.WrapErrParameterInvalidMsg("expected *schemapb.VectorField, got %T", v)
			}
			...
			if !ok {
				return merr.WrapErrParameterInvalidMsg("expected *array.ListBuilder, got %T", b)
			}
			...
			case schemapb.DataType_FloatVector:
				if vf.GetFloatVector() == nil {
					return merr.WrapErrParameterInvalidMsg("FloatVector data is nil for elementType FloatVector")
				}
			...
			case schemapb.DataType_BinaryVector:
				if vf.GetBinaryVector() == nil {
					return merr.WrapErrParameterInvalidMsg("BinaryVector data is nil for elementType BinaryVector")
				}
				return appendVectorChunks(vf.GetBinaryVector(), int((dim+7)/8))

			case schemapb.DataType_Float16Vector:
				if vf.GetFloat16Vector() == nil {
					return merr.WrapErrParameterInvalidMsg("Float16Vector data is nil for elementType Float16Vector")
				}
				return appendVectorChunks(vf.GetFloat16Vector(), int(dim)*2)

			case schemapb.DataType_BFloat16Vector:
				if vf.GetBfloat16Vector() == nil {
					return merr.WrapErrParameterInvalidMsg("BFloat16Vector data is nil for elementType BFloat16Vector")
				}
				return appendVectorChunks(vf.GetBfloat16Vector(), int(dim)*2)

			case schemapb.DataType_Int8Vector:
				if vf.GetInt8Vector() == nil {
					return merr.WrapErrParameterInvalidMsg("Int8Vector data is nil for elementType Int8Vector")
				}
			...
			default:
				return merr.WrapErrParameterInvalidMsg("unsupported elementType for ArrayOfVector: %s", elementType.String())
			}
		},
	}
	...
	fixedSizeDeserializer := func(a arrow.Array, i int, _ schemapb.DataType, _ int, shouldCopy bool) (any, error) {
		...
		return nil, merr.WrapErrParameterInvalidMsg("expected *array.FixedSizeBinary, got %T", a)
	}
	fixedSizeSerializer := func(b array.Builder, v any, _ schemapb.DataType) error {
		...
		if v, ok := v.([]byte); ok {
			...
			return merr.WrapErrParameterInvalidMsg("expected []byte value, got %T", v)
		}
		return merr.WrapErrParameterInvalidMsg("expected *array.FixedSizeBinaryBuilder, got %T", b)
	}
	...
	m[schemapb.DataType_Int8Vector] = serdeEntry{
		...
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			...
			if vv, ok := v.([]byte); ok {
				...
				return merr.WrapErrParameterInvalidMsg("expected []byte or []int8 value, got %T", v)
			}
			if builder, ok := b.(*array.FixedSizeBinaryBuilder); ok {
	...
	m[schemapb.DataType_FloatVector] = serdeEntry{
		...
		serialize: func(b array.Builder, v any, _ schemapb.DataType) error {
			...
			if vv, ok := v.([]float32); ok {
				...
				return merr.WrapErrParameterInvalidMsg("expected *array.FixedSizeBinaryBuilder or *array.BinaryBuilder, got %T", b)
			}
			return merr.WrapErrParameterInvalidMsg("expected *array.FixedSizeBinaryBuilder, got %T", b)
		},
	}
...
func createEmptyVectorField(elementType schemapb.DataType, dim int64) (*schemapb.VectorField, error) {
	...
	default:
		return nil, merr.WrapErrParameterInvalidMsg("unsupported element type for empty ArrayOfVector: %s", elementType.String())
	}
}
...
func deserializeArrayOfVector(a arrow.Array, i int, elementType schemapb.DataType, dim int64, shouldCopy bool) (any, error) {
	...
	arr, ok := a.(*array.List)
	if !ok {
		return nil, merr.WrapErrParameterInvalidMsg("expected *array.List for ArrayOfVector, got %T", a)
	}
	if i >= arr.Len() {
		return nil, merr.WrapErrParameterInvalidMsg("index %d out of bounds for array of length %d", i, arr.Len())
	}
	...
	if !ok {
		return nil, merr.WrapErrParameterInvalidMsg("expected *array.FixedSizeBinary for ArrayOfVector values, got %T", valuesArray)
	}
	...
	default:
		return nil, merr.WrapErrParameterInvalidMsg("unsupported element type for ArrayOfVector deserialization: %s", elementType.String())
	}
}
